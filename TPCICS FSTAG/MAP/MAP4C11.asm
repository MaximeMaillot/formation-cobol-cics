        PRINT NOGEN
MAP4C11 DFHMSD TYPE=&SYSPARM,MODE=INOUT,LANG=COBOL,                    X
               CTRL=(FREEKB,FRSET),STORAGE=AUTO,TIOAPFX=YES
* Map de la suppression d'un stagiaire
MAP4   DFHMDI COLUMN=1,LINE=1,SIZE=(24,80),MAPATTS=(COLOR,HILIGHT),    X
...
IDENT   DFHMDF POS=(1,1),                                              X
        ...
        DFHMDF POS=(1,25),COLOR=RED,                                   X
               ...
               INITIAL='SUPPRESSION D''UN STAGIAIRE'
